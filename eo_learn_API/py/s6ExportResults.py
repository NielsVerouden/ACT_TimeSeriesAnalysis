...
def exportResults(eopatch, file_name, dest_name):
    # Define export paths
    vv_path = dest_name+'/'+file_name+"/VV_temp.tif"
    vh_path = dest_name+'/'+file_name+"/VH_temp.tif"
    dem_path = dest_name+'/'+file_name+"/DEM_temp.tif"
