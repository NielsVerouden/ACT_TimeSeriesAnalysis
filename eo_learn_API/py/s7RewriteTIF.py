...
def rewriteTIF(eopatch, dest_name, file_name, vv_path, vh_path, dem_path):
    ...
    for i in range(len(timestamp)):
        ...
        stack_filepath= os.path.join(dest_name, file_name, stack_filename)
    ...
    if stack_filename in stack_filepath and vv_path not in stack_filepath:
        return names